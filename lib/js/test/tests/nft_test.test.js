...
import {
    emulator,
    getAccountAddress,
    init, sendTransaction, shallPass, shallRevert, shallThrow,
...
describe("NonFungibleToken Contract Tests", () => {
    ...
    test("Should be able to mint a token", async () => {
        ...
        await assertNFTInCollection(nftAccount, expectedFirstNFTID);
        ...
        // Ensure NFT of ID 0 is in nftAccount's collection
        await assertNFTInCollection(nftAccount, expectedSecondNFTID);
    ...
    test("Should be able to withdraw an NFT and deposit to another accounts collection", async () => {
        ...
        await assertNFTInCollection(nftAccount, expectedNFTID);
        ...
        await assertNFTInCollection(joshAccount, expectedNFTID);
    });
