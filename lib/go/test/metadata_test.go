...
func TestGetNFTMetadata(t *testing.T) {
	...
	t.Run("Should be able to verify the metadata of the minted NFT through the Display View", func(t *testing.T) {
		...
		assert.Equal(t, fooTraitType, fooTrait.Fields[0])
